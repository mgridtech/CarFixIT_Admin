...
//   return (
//     <Spring
//       className="flex flex-col items-center justify-between rounded-md shadow-banner py-[30px] px-5
//                 text-white text-center bg-radial-blue h-[390px]"
//     >
//       <div className="relative flex flex-1">
//         <img
//           className="relative max-h-[200px] w-auto mt-auto -right-[26px]"
//           src={cards}
//           alt="media"
//         />
//         <div className="lens absolute z-10 w-[215px] h-[215px] top-0 left-1/2 -translate-x-1/2">
//           <img
//             className="opacity-[.85] w-[93px] ml-2.5 mt-2.5"
//             src={security}
//             alt="media"
//           />
...
//         </div>
//         <span
//           className="block absolute w-[210px] h-[210px] bg-green blur-xl rounded-full opacity-30 right-0
//                       -bottom-1/3"
//         />
//       </div>
