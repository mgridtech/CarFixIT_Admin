...
//       <div
//         className="flex flex-col items-center text-center relative z-20 h-full md:pl-8 md:justify-center
//                  3xl:justify-start 3xl:pl-0"
//       >
//         <img
//           className="w-auto max-h-[340px] -mt-2.5 md:hidden 3xl:block"
//           src={world}
//           alt="media"
//         />
//         <img
//           className="absolute w-auto h-12 left-5 bottom-10"
//           src={bubbles}
//           alt="media"
//         />
//         <img
//           className="absolute w-auto h-[100px] right-0 bottom-0"
//           src={gear}
//           alt="media"
//         />
//         <h3 className="max-w-[280px]">Worldwide Transactions</h3>
...
//       </div>
//       <img
//         className="absolute z-10 left-0 bottom-5 md:hidden 3xl:block"
//         src={map}
//         alt="media"
//       />
//     </Spring>
